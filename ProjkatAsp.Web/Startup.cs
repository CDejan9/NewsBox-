...
using ProjekatASP.EfCommands.KorisnikCommands.WebCommand;

namespace ProjkatAsp.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IGetKorisniciWEBCommand, EFGetKorisniciWEBCommand>();
            services.AddTransient<IGetKorisnikGetWebCommand, EFGetKorisnikWebCommand>();
